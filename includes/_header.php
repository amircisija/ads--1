...
<head>
    ...
    <script src="https://kit.fontawesome.com/fab936345c.js" crossorigin="anonymous"></script>
    <link
    ...
    <link href="https://fonts.googleapis.com/css?family=Poppins:100,200,300,400,500,600,700,800,900&display=swap"
        rel="stylesheet">
    <title>Klick Media | Ihre Online Marketing Agentur</title>
</head>

<body>
    <div id="top__bar--navigation">
                ...
                <div class="row">
                    <div class="col-xs-12 col-lg-8 ml-auto text-right">
                        <ul class="top--contact--info">
                            ...
                            <li><i class="fas fa-phone-square-alt"></i> <span>Telefon:</span> + 123 456 789</li>
                            <li><i class="fas fa-envelope-square"></i> <span>E-Mail:</span> info@domain.de</li>
                        </ul>
                    </div>
                </div>
            </div>
        </div>
        <header class="main--header fixed-top" id="header--top">
            <nav class="navbar navbar-expand-lg navbar-light bg-light">
                <div class="container">
                    <a class="navbar-brand" href="#"><img src="assets/img/logo-big.png" class="img-fluid" width="280"
                            alt=""></a>
